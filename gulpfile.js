'use strict';
// generated on 2014-10-24 using generator-gulp-webapp 0.1.0
...
gulp.task('serve', ['browser-sync', 'html']);
...
gulp.task('wiredep', function () {
    ...
    gulp.src('app/templates/layouts/*.html')
        .pipe(wiredep({
            directory: 'app/bower_components',
            ignorePath: '../../',
            exclude: ['bootstrap-sass-official', 'bower_components/modernizr/modernizr.js']
        }))
...
gulp.task('optimize', ['uncss'], function () {
    gulp.start('critical');
});
